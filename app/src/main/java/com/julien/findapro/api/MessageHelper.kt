...
public class MessageHelper {
    ...
    companion object{
        ...
        fun createMessageWhithImageForChat(textMessage:String,urlImageSender:String,userSender:String,assignmentsId: String,urlImageMessage: String):Task<DocumentReference>{
            val db = FirebaseFirestore.getInstance()
            val message = Message(textMessage,urlImageSender,userSender,urlImageMessage)
