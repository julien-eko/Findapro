...
class AssignmentsInProgressAdapter(var assignmentList: ArrayList<HashMap<String,String>>, val context: Context, val clickListener: (HashMap<String,String>) -> Unit):
